...
public class PanneauCombat extends JPanel {
	...
	/*
	 * public void setImageJ1(int i){ if(i==MAGE) imgJ1 = Toolkit.getDefaultToolkit().getImage("img/mage.png"); else if(i==GUERRIER) imgJ1 =
	 * Toolkit.getDefaultToolkit().getImage("img/guerrier.png"); else imgJ1 = Toolkit.getDefaultToolkit().getImage("img/athlete.png"); } public void
	 * setImageJ2(int i){ if(i==MAGE) imgJ2 = Toolkit.getDefaultToolkit().getImage("img/mage.png"); }
	 */
